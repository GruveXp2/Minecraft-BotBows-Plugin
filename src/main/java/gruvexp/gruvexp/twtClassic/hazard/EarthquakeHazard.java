...
import gruvexp.gruvexp.tasks.PlayerEarthQuakeTimer;
...
public class EarthquakeHazard extends Hazard{
    ...
    protected void trigger() {
        BotBows.messagePlayers(STR."\{ChatColor.DARK_RED}EARTHQUAKE INCOMING!\{ChatColor.RED} Stay above ground!");
        BotBows.titlePlayers(STR."\{ChatColor.RED}EARTHQUAKE INCOMING", 80);
