...
public class BotBowsPlayer {
    ...
    public void handleHit(BotBowsPlayer attacker) {
        ...
        isDamaged = true;
        for (int i = 0; i < 9; i++) { // fyller inventoriet med barrier blocks for å vise at man ikke kan skyte eller bruke abilities
        ...
        Bukkit.getScheduler().runTaskLater(Main.getPlugin(), () -> {
            ...
            PLAYER.setInvulnerable(false);
            isDamaged = false;
            for (int i = 0; i < 9; i++) { // barrier blocksene tas vekk igjen og
